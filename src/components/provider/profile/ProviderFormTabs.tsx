...
import { BasicProfileInfo } from "@/components/provider/profile/BasicProfileInfo";
import { ContactInfo } from "@/components/provider/profile/ContactInfo";
import { ProviderInfo } from "@/components/provider/profile/ProviderInfo";

interface ProviderFormTabsProps {
  activeTab: string;
